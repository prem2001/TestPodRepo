...
#                      DESC
  ...
  s.homepage         = 'https://github.com/prem2001/TestPodRepo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'prem' => 'premnath101070@gmail.com' }
  s.source           = { :git => 'https://github.com/prem2001/TestPodRepo.git', :tag => s.version.to_s }
