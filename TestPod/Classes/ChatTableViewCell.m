...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[chatNameLabel]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatNameLabel)];
    ...
    vertical = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-4-[chatNameLabel]-2-[chatMessageLabel]-2-[chatTimeLabel]-4-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(chatNameLabel,chatMessageLabel,chatTimeLabel)];
...
-(void)layoutSubviews
{
    ...
    Main.layer.cornerRadius = 5.0f;//bubble radius
...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    {
        //self message or sender or visitor message
        //Setting constraints for Bubble. It should be at a zero distance from top, bottom and 8 distance right hand side of the superview, i.e., self.contentView (The default superview for all tableview cell elements)
        ...
        //prem right bubble margine
        horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[Main]-(-58)-[DownCurve]-(0)-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(Main,DownCurve)];
        ...
        horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[chatTimeLabel]-5-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatTimeLabel)];
        ...
        horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[chatMessageLabel]-5-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatMessageLabel)];
        ...
        {
            [DownCurve setHidden:YES];//do YES if want bubble notch or tail.
            [UpCurve setHidden:YES];//do YES if want bubble notch or tail.
        }
        else
        {
    ...
    else
    {
        ...
        //other message or receiving messsage
        ...
        //prem left bubble margine.
        horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[DownCurve]-(-58)-[Main]" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(DownCurve,Main)];
        ...
        {
            [DownCurve setHidden:YES];//do yes if want tail or notch
            [UpCurve setHidden:YES];//do yes if want tail or notch
        }
        else
        {
            [DownCurve setHidden:YES];
    ...
    Bubble.backgroundColor=[UIColor colorWithRed:1 green:1 blue:1 alpha:0.0];
    
    
    HidingLayerTop.backgroundColor=[UIColor colorWithRed:1 green:1 blue:1 alpha:0.0];
    HidingLayerSide.backgroundColor=[UIColor colorWithRed:1 green:1 blue:1 alpha:0.0];
